...
lib.ssMetadata = [
		{name:"test_result_cat_atlas_1", frames: [[935,1083,931,140],[0,1083,933,142],[935,1225,931,140],[0,1227,931,140],[933,1367,931,140],[0,0,1921,1081]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.golist_btn.setTransform(1643.1,1018.85,1.0695,1.0498,0,0,0,217.5,32.6);
	new cjs.ButtonHelper(this.golist_btn, 0, 1, 2, false, new lib.golist_btn(), 3);

	this.instance = new lib.最終畫面_CAT影像();
